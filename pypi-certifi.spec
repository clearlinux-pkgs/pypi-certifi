...
%prep
%setup -q -n certifi-2025.1.31
cd %{_builddir}/certifi-2025.1.31
%patch -P 1 -p1
pushd ..
cp -a certifi-2025.1.31 buildavx2
popd
pushd ..
cp -a certifi-2025.1.31 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738349225
