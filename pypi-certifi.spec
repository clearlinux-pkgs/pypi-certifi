...
Source0  : https://files.pythonhosted.org/packages/0f/bd/1d41ee578ce09523c81a15426705dd20969f5abf006d1afe8aeff0dd776a/certifi-2024.12.14.tar.gz
...
%prep
%setup -q -n certifi-2024.12.14
cd %{_builddir}/certifi-2024.12.14
%patch -P 1 -p1
pushd ..
cp -a certifi-2024.12.14 buildavx2
popd
pushd ..
cp -a certifi-2024.12.14 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735094084
