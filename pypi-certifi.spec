...
Source0  : https://files.pythonhosted.org/packages/07/b3/e02f4f397c81077ffc52a538e0aec464016f1860c472ed33bd2a1d220cc5/certifi-2024.6.2.tar.gz
...
%prep
%setup -q -n certifi-2024.6.2
cd %{_builddir}/certifi-2024.6.2
%patch -P 1 -p1
pushd ..
cp -a certifi-2024.6.2 buildavx2
popd
pushd ..
cp -a certifi-2024.6.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717431664
