...
Source1  : https://files.pythonhosted.org/packages/37/f7/2b1b0ec44fdc30a3d31dfebe52226be9ddc40cd6c0f34ffc8923ba423b69/certifi-2022.12.7.tar.gz.asc
...
%prep
%setup -q -n certifi-2022.12.7
cd %{_builddir}/certifi-2022.12.7
%patch1 -p1
pushd ..
cp -a certifi-2022.12.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678497368
