...
%prep
%setup -q -n certifi-2024.8.30
cd %{_builddir}/certifi-2024.8.30
%patch -P 1 -p1
pushd ..
cp -a certifi-2024.8.30 buildavx2
popd
pushd ..
cp -a certifi-2024.8.30 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725003962
