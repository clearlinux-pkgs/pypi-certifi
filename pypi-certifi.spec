...
Source0  : https://files.pythonhosted.org/packages/e8/9e/c05b3920a3b7d20d3d3310465f50348e5b3694f4f88c6daf736eef3024c4/certifi-2025.4.26.tar.gz
...
%prep
%setup -q -n certifi-2025.4.26
cd %{_builddir}/certifi-2025.4.26
%patch -P 1 -p1
pushd ..
cp -a certifi-2025.4.26 buildavx2
popd
pushd ..
cp -a certifi-2025.4.26 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745700206
